...
[[Ambassadors]{.ul}](https://unitary.fund/posts/2022_ambassadors.html):
...
[[automated error mitigation]{.ul}](https://arxiv.org/abs/2210.08611)
and testing error mitigation with Mitiq
[[out-of-the-box]{.ul}](https://arxiv.org/abs/2210.07194) on different
hardware -- improving results of NISQ devices.

New projects joined the Unitary Fund
[[Discord]{.ul}](https://discord.com/invite/JqVGmpkP96): OpenQAOA and
...
Survey]{.ul}](https://unitary.fund/posts/2022_survey_results.html):
...
-   **Mitiq**
    ...
    -   New Releases:
        > [[v0.20.0]{.ul}](https://github.com/unitaryfund/mitiq/releases/tag/v0.20.0),
        > [[v0.21.0]{.ul}](https://github.com/unitaryfund/mitiq/releases/tag/v0.21.0),
        > [[v0.22.0]{.ul}](https://github.com/unitaryfund/mitiq/releases/tag/v0.22.0)
        ...
        -   Read more in our updated
            > [[Examples]{.ul}](https://mitiq.readthedocs.io/en/stable/examples/examples.html)
            > section.
...
-   **Research**
    ...
    -   [[arxiv:2210.08611]{.ul}](https://arxiv.org/abs/2210.08611)
    ...
    -   [[arxiv:2210.07194]{.ul}](https://arxiv.org/abs/2210.07194)
...
-   **New Grant**
    ...
    -   To [**[Lev Stambler]{.ul}**](https://github.com/Lev-Stambler) to
...
-   **QuTiP**
    ...
    -   QuTiP 4.7.1 was released --
        > [[https://github.com/qutip/qutip/releases/tag/v4.7.1v]{.ul}](https://github.com/qutip/qutip/releases/tag/v4.7.1v)

    -   QuTiP QIP 0.2.3 was released --
        > [[https://github.com/qutip/qutip-qip/releases/tag/v0.2.3]{.ul}](https://github.com/qutip/qutip-qip/releases/tag/v0.2.3)
...
-   **A methods focused guide to quantum error correction:** The initial
    ...
    > [[online]{.ul}](https://abdullahkhalid.com/qecft/). Please watch
...
-   **Inside Quantum**
    ...
    -   The insideQuantum podcast has completed its first season of 12
        ...
        > website
        > ([[insidequantum.org]{.ul}](http://insidequantum.org/)) or on
...
-   Xanadu's QHack comes back this February, you can [[register here]{.ul}](https://qhack.ai/)

-   There are still a few days to sign up to [[MIT's iQuHACK]{.ul}](https://www.iquise.mit.edu/iQuHACK/2023-01-27)