...
more in [this blog
post](https://unitary.fund/posts/calibration.html). You can use
...
-   **Mitiq**
    ...
    -   Talks:
        ...
        -   [MSc course in AI Univ of
            > Milan](https://en.unimib.it/graduate/artificial-intelligence)
...
-   [**[Metriq]{.ul}**](https://metriq.info/)
    ...
    -   Hackathon contributors to Metriq added LaTeX parsing and
        ...
        > including results from our [benchmark
        > pipeline](https://unitary.fund/posts/2023_metriq_qedc.html).

-   **UF Research**

    -   [\[2304.14969\] Exact and approximate simulation of large
        > quantum circuits on a single
        > GPU](https://arxiv.org/abs/2304.14969)

    -   [\[2304.14985\] Zero noise extrapolation on logical qubits by
        > scaling the error correction code
        > distance](https://arxiv.org/abs/2304.14985)

    -   [\[2306.15863\] Increasing the Measured Effective Quantum
        > Volume with Zero Noise
        > Extrapolation](https://arxiv.org/abs/2306.15863)
